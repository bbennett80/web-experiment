        ...
        function (e, t, r) {
            ...
            e.exports = function () {
                ...
                return (
                    ...
                    { id: t, worker: k, setResolve: P, setReject: S, load: L, writeText: T, readText: R, removeFile: _, FS: A, loadLanguage: D, initialize: N, setParameters: F, recognize: I, getPDF: M, detect: C, terminate: z }
                );
            };
        },
        function (e, t) {
